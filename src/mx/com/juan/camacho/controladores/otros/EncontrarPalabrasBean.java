...
@ManagedBean
@ViewScoped
public class EncontrarPalabrasBean extends mx.com.juan.camacho.beans.GeneralBean {
	...
	public EncontrarPalabrasBean() {
		this.numPalabrasEncontradas = 0;
	}
	@javax.annotation.PostConstruct
	public void init() {
		try {
			this.tiempoOtro = (TiempoOtro)this.dataSource.consultarObjeto("SELECT tiempoOtro FROM TiempoOtro tiempoOtro WHERE tiempoOtro.prueba = 'ENCONTRARPALABRAS' AND tiempoOtro.userapp.id = " + this.usuarioBean.getUserappSession().getId());
		} catch(Exception e) {}
	}
	
	public void finalizarPrueba() {
		try {
			if(this.numPalabrasEncontradas >= 20) {
				...
				this.mostrarModal("Has encontrado " + this.numPalabrasEncontradas + " de 20", "error");
			}
		} catch(Exception e) {
	...
	public void iniciarPrueba() {
		...
		this.tiempoOtro.setPrueba("ENCONTRARPALABRAS");
